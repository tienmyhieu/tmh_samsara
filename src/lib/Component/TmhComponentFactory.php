...
require_once('TmhDefaultTitleUploadGroupComponent.php');
...
require_once('TmhNumberedTopicComponent.php');
require_once('TmhPaleTextComponent.php');
require_once('TmhQuoteComponent.php');
...
require_once('TmhTranslatedQuoteComponent.php');
require_once('TmhUploadGroupComponent.php');
require_once('TmhUploadGroupListComponent.php');
require_once('TmhVerticalQuoteListComponent.php');
...
class TmhComponentFactory
{
    ...
    public function create(string $type): TmhComponent
    {
        return match($type) {
            ...
            'default_title_upload_group' => new TmhDefaultTitleUploadGroupComponent($this->database),
            ...
            'numbered_topic' => new TmhNumberedTopicComponent(),
            'pale_text' => new TmhPaleTextComponent(),
            'quote' => new TmhQuoteComponent(),
            ...
            'translated_quote' => new TmhTranslatedQuoteComponent(),
            ...
            'vertical_quote_list' => new TmhVerticalQuoteListComponent($this, $this->structure),
