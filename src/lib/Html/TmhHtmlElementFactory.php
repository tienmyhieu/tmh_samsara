...
class TmhHtmlElementFactory
{
    ...
    {
        return $this->nodeFactory->span('tmh_indented_small_text', $innerHtml);
    }

    public function indentedFartherSmallText(string $innerHtml): array
    {
        return $this->nodeFactory->span('tmh_indented_farther_small_text', $innerHtml);
    }
    ...
    public function keyValueValue(string $value): array
    {
        return $this->nodeFactory->span('', $value);
    }
    ...
    {
        return $this->nodeFactory->span('tmh_pale_text', $innerHtml);
    }
    ...
    public function quoteListItem(array $childNodes): array
    {
        return $this->nodeFactory->div('tmh_quote_list_item', $childNodes, '');
    }
    ...
    {
        return $this->nodeFactory->span('tmh_small_text', $innerHtml);
    }

    public function span(string $class, string $innerHtml): array
    {
        return $this->nodeFactory->span($class, $innerHtml);
    }
    ...
    public function topic(string $title): array
    {
        return $this->nodeFactory->div('tmh_topic', [$this->nodeFactory->span('', $title)], '');
    }
